...
这些技能目前都是 `experimental`。以下内容用于手动试用，不是新的行为评测证据。文件整理、沟通演练与 React 性能审查当前为 0.1.1，修订及适用范围见[首轮质量打磨报告](quality-polish-round-01.md)。故障证据排查、决策简报与会议沟通复盘也已升至 0.1.1，见[第二轮质量打磨报告](quality-polish-round-02.md)。
